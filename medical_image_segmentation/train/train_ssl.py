...
parser.add_argument(
    "--arch", default="resnet18", type=str, help="backbone architecture"
)
...
parser.add_argument(
    "--linear_loss_weight", default=0.03, type=float, help="weight for the linear loss"
)
parser.add_argument(
    "--momentum_opt", default=0.9, type=float, help="momentum for optimizer"
)
...
parser.add_argument(
    "--hidden_dim", default=4096, type=int, help="hidden dim in proj/pred head"
)
parser.add_argument(
    "--base_momentum", default=0.99, type=float, help="base momentum for byol"
)
parser.add_argument(
    "--final_momentum", default=1.0, type=float, help="final momentum for byol"
)
parser.add_argument(
    "--comment",
...
parser.add_argument(
    "--project", default="essential-byol", type=str, help="wandb project"
)
parser.add_argument("--entity", default=None, type=str, help="wandb entity")
parser.add_argument(
    "--offline", default=False, action="store_true", help="disable wandb"
)
parser.add_argument(
    "--num_gpus",
...
parser.add_argument(
    "--max_epochs", default=100, type=int, help="Number of training epochs"
)
